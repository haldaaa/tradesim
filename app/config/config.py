...
RECHARGE_BUDGET_MIN = 200             # Montant minimum de recharge de budget
RECHARGE_BUDGET_MAX = 600             # Montant maximum de recharge de budget
...
BONUS_INFLATION_PRODUIT_EXISTANT = 15 # Bonus d'inflation pour produit déjà affecté
